...
lcbc20up2 <- data.frame(t(lcbc20up))
...
colnames(df024)[1] <- "compared_municipalities"
colnames(df024)[2] <- "distances"
colnames(df024)[3] <- "compared_populations"
colnames(df024)[4] <- "compared_locations"
colnames(df024)[5] <- "compared_pop_10e5_20e5"
colnames(df024)[6] <- "compared_pop_over_20e5"
colnames(df024)[7] <- "muni_i"
colnames(df024)[8] <- "muni_j"
colnames(df024)[9] <- "pop_i"
colnames(df024)[10] <- "pop_j"
colnames(df024)[11] <- "lonlat_i"
colnames(df024)[12] <- "lonlat_j"
colnames(df024)[13] <- "pop_10e5_20e5_i"
colnames(df024)[14] <- "pop_10e5_20e5_j"
colnames(df024)[15] <- "pop_over_20e5_i"
colnames(df024)[16] <- "pop_over_20e5_j"

df024$below_10e5 <- 2
for (i in 1:nrow(df024)){
  ifelse(
    ((as.integer(df024$pop_10e5_20e5_i[i]) == as.integer(0))
     && (as.integer(df024$pop_10e5_20e5_j[i]) == as.integer(0))
     && (as.integer(df024$pop_over_20e5_i[i]) == as.integer(0))
     && (as.integer(df024$pop_over_20e5_j[i]) == as.integer(0)))
    , df024$below_10e5[i] <- 1
    , ifelse(
      ((as.integer(df024$pop_10e5_20e5_i[i]) == as.integer(1))
       || (as.integer(df024$pop_10e5_20e5_j[i]) == as.integer(1))
       || (as.integer(df024$pop_over_20e5_i[i]) == as.integer(1))
       || (as.integer(df024$pop_over_20e5_j[i]) == as.integer(1)))
      , df024$below_10e5[i] <- 0
      , df024$below_10e5[i] <- 1)
  )
}

lcl_lons <- data.frame(strsplit(as.character(df024$lonlat_i), ','))
lcl_lons2 <- data.frame(t(lcl_lons), stringsAsFactors = TRUE)
lcl_lats <- data.frame(strsplit(as.character(df024$lonlat_j), ','))
lcl_lats2 <- data.frame(t(lcl_lats), stringsAsFactors = TRUE)

df025 <- data.frame(lcl_lons2, lcl_lats2)
df03 <- data.frame(df024, df025)

rm(df011);rm(df012);rm(df013);rm(df014)
rm(df020);rm(df021);rm(df022);rm(df023);rm(df024);rm(df025)

colnames(df03)[18] <- "lon_i"
colnames(df03)[19] <- "lat_i"
colnames(df03)[20] <- "lon_j"
colnames(df03)[20] <- "lat_j"
...
df03$pop_10e5_20e5_i <- unfactor(df03$pop_10e5_20e5_i)
df03$pop_10e5_20e5_j <- unfactor(df03$pop_10e5_20e5_j)
df03$pop_over_20e5_i <- unfactor(df03$pop_over_20e5_i)
df03$pop_over_20e5_j <- unfactor(df03$pop_over_20e5_j)
