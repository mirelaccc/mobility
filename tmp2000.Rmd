...
# Start: set wd, read in data, load libs -> df01
```{r}
...
# reorde cols for better overview
df011 <- df01[,c(1,3,4,2,5,8,6,7,11,9,10)]
...
# populations
compared_pop <- data.frame(combn(as.character(df01$population_01042017), 2, FUN = paste, collapse="_"))
...
Reduce(function(x, y) merge(x, y, all=TRUE), list(compared_municipalities, compared_locations, compared_pop, compared_pop_norm, compared_pop_under_10e5, compared_pop_10e5_20e5, compared_pop_over_20e5, compared_pop_norm_below01, compared_pop_norm_0102, compared_pop_norm_02up))
